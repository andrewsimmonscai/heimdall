...
"Page 1 Share of Shelf": function(browser) {
    ...
    var baseUrl = browser.launchUrl || `https://ca-prod.contentanalyticsinc.com`;
     ...
     browser
      .url(`${baseUrl}/assess/brand_report_ranking`)
      .pause(4000)
      .click(`div:nth-of-type(2) > div > div:nth-of-type(3) > div:nth-of-type(3) > div:nth-of-type(2) > aside > div > div:nth-of-type(2)`, `CSS`, `Click element`)
      .pause(5000)
      .click(`#lc-cbx-shelf_pages_list_filter_block-101`, `CSS`, `Click element`)
      .pause(500)
      ...
      .pause(3000)
      .elementPresent(`#ranking-results-container`, `CSS`, `Results Table is loading`)
      .assert.visible("#ranking-results-container", `Results Table is visible`)
      .end();
  }
};
...
function bindHelpers(browser) {
  ...
  browser.url = function(pathname, description) {
